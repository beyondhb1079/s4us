...
4. **Escalation:** If the error requires a deep architectural rewrite (e.g., the Data Shield fundamentally broke a Firestore hook), you must leave a comment on the PR tagging the responsible agent to fix their own mess.
